...
<ul>
  ...
  <li> The program implements object oriented programming use 3 main objects to represent the state of the game, the players view, and the interface between the two. 
</ul>
